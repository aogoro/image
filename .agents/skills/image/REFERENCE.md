...
1. **Codex CLI** (`codex` в PATH) — установка: `npm i -g @openai/codex`
2. **OPENAI_API_KEY** — env-переменная с доступом к Images API
3. **exec-скрипт** — `$SKILL_ROOT/.agents/scripts/codex-exec.sh`
